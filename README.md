...
## Reglas
* Se puede jugar entre un mínimo de dos y un máximo de cuatro personas.
...
* Al jugador se le mostrará el índice de sus cartas, que valor y color tiene, de escoger una carta que no coincida, se repetira
  la anterior instrucciòn, hasta que escoja una carta correcta ó tome una de la baraja hasta que coindida.
